...
- [Product](product.md) — to-prd, write-spec, write-user-story
- [Utility](utility.md) — audit-skill-security, avoid-ai-writing, git-branch, git-commit
- [Lifestyle](lifestyle.md) — lawyer, landscape-design
- [Documentation (in-progress)](documentation.md) — write-api-docs, write-changelog, write-readme, write-release-notes, write-runbook, write-ticket, manage, markitdown
