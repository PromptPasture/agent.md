...
- These instructions govern document writing only. Repository workflow, code changes, implementation behavior, and response requirements remain governed by the root `AGENTS.md`.
