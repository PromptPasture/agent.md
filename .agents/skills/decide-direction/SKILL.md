...
description: Compare options and recommend a direction. Use for "decide-direction", "choose", "which option", "tradeoffs", "recommend", "should we", and option selection with criteria, risks, and reversibility.
license: MIT
version: 1.0.0
tags:
  - decide-direction
...
- **Trigger on selection**: use for "decide-direction", "choose", "which option", "tradeoffs", "recommend", "should we", and similar decision requests.
