---
name: coordinate
description: Manage active work across people, agents, tasks, dependencies, blockers, and handoffs. Use for "coordinate", "manage this work", "lead this", "assign", "delegate", "track blockers", "status", "handoff", and multi-workstream execution.
license: MIT
version: 1.0.0
tags:
  - coordinate
...
- **Trigger on coordination**: use for "coordinate", "manage this work", "team lead", "lead this", "assign", "delegate", "track blockers", "status", "handoff", and multi-agent or multi-workstream requests.
