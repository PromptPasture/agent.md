...
**Test gaps usually belong under `Test gaps`, not `Findings`.**
...
**Check that changed behavior is proven by targeted coverage.**
...
**Check that tests fail for the behavior they claim to prove.**
...
**Check for nondeterminism before trusting passing tests.**
...
**Check that useful tests actually run and stay maintainable.**
