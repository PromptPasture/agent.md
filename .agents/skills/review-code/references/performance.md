...
**A performance finding should identify the runtime path, scaling variable, and changed cost.**

Avoid comments that only say something "might be slower" without a plausible size or frequency.

## Backend And Data

**Check server-side work that scales with requests, data, or fanout.**
...
**Check client-side work that affects responsiveness, loading, or layout stability.**
...
**Check whether parallel work, retained resources, or cost can grow without bounds.**
