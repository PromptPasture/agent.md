...
| [`code-tests`](software-engineering/code-tests/SKILL.md) | Automated tests and evals, including E2E, API, integration, performance, AI output, tool-use, RAG, and prompt regression suites. | [`references/`](software-engineering/code-tests/references/), [`scripts/`](software-engineering/code-tests/scripts/) |
