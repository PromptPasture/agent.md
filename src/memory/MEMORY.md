...
- **Memory stores small completed task notes** — Use `src/memory/YYYY-MM-DD.md` for small task observations that do not need a PRD, SPEC, architecture, or design document.
...
- **Library skills have a table-of-contents README** — `src/skills/README.md` indexes the maintained skills.
...
- **Creator skills support multiple agent runtimes** — `src/skills/create-skill` guidance and scripts avoid assuming a single coding-agent runtime.
...
**Decision:** Preserve those notes in `src/memory/2026-05-14.md` and reserve docs task folders for work that needs task-scoped PRD, SPEC, architecture, or design documentation.
